...
export default {
  ...
  methods: {
    fetchProjects(){
        ...
        axios.get(this.baseURL+'/api/user/projects', { headers })
        .then(response => {
    ...
    fetchBedrooms(){
        ...
        axios.get(this.baseURL+'/api/user/bedrooms', { headers })
        .then(response => {
        if(response.data.status)
        {
    ...
    fetchCurrencies(){
        ...
        axios.get(this.baseURL+'/api/user/currencies', { headers })
        .then(response => {
        if(response.data.status)
        {
    ...
    fetchProperties(){
        ...
        axios.get(this.baseURL+'/api/user/property/'+this.id, { headers })
        .then(response => {
        if(response.data.status)
        {
    ...
    update(e){
      ...
      axios.post(this.baseURL+'/api/user/property/'+this.id+'/update', this.form, { headers })
      .then(response => {
        if(!response.data.status)
        {
