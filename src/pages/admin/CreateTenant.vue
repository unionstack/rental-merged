      ...
      <Row utils="g-gs">
        <Col xxl="12">
          <CardBody class="flex-grow-0 py-2">
            <CardTitleGroup>
              <CardTitle tag="div">
                <h3 class="title">Create Tenant</h3>
              </CardTitle>
              <CardTools>
          ...
          <Card class="mb-4">
              <CardBody>
                  ...
                  <div class="row g-3 gx-gs mb-4">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            <label  class="form-label">Real Contract End <span class="text-danger">*</span></label>
                            <div class="form-control-wrap">
...
// import DatePicker from '@/components/forms/date-picker/DatePicker.vue';
...
export default {
  ...
  methods: {
    ...
    create(e){
      ...
      axios.post(this.baseURL+'/api/admin/create/tenant', this.form, { headers })
      .then(response => {
        if(!response.data.status)
        {
