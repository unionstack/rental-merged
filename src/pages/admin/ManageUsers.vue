        ...
        <Col xxl="12">
          <CardBody class="flex-grow-0 py-2">
            <CardTitleGroup>
              ...
              <CardTools>
                <Button type="button" variant="primary" soft class="" style="float:right;" as="RouterLink" to="/admin/user/create"><Icon icon="plus"/>   Create User</Button> 
                ...
                <DataTable id="datatable-init-2" class="table-border">
                  <TableHead>
                      <tr>
                          ...
                          <th><OverlineTitle tag="span">Currency</OverlineTitle></th>
  ...
  export default {
    ...
    methods: {
      ...
      deleteRecord(e)
      {
        ...
        axios.post(this.baseURL+'/api/admin/user/delete', data, { headers })
        .then(response => {
          if(response.data.status)
          {
