      ...
      <Row utils="g-gs">
        <Col xxl="12">
          <CardBody class="flex-grow-0 py-2">
            <CardTitleGroup>
              <CardTitle tag="div">
                <h3 class="title">Create Currency</h3>
              </CardTitle>
              <CardTools>
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <div class="form-control-wrap">
                                  <FormInput type="text"  v-model="form.name" placeholder="Enter Currency" required/>
                              </div>
                          </div>
                      </div>
                  </div>
...
export default {
  ...
  methods: {
    create(e){
      ...
      axios.post(this.baseURL+'/api/admin/create/currency', this.form, { headers })
      .then(response => {
