                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <div class="form-control-wrap">
                                  <FormInput type="text" v-model="form.name" required placeholder="Enter Project Name"/>
...
export default {
  ...
  methods: {
    fetchProject(){
      ...
      // console.log(this.id);
      axios.get(this.baseURL+'/api/admin/'+this.id+'/edit-project/', { headers })
      .then(response => {
        if(response.data.status)
        {
          this.project_data = response.data.data;
          this.form.name = this.project_data[0].name;
        }
      });
    },
    update(e){
      ...
      axios.post(this.baseURL+'/api/admin/project/'+this.id+'/update', this.form, { headers })
      .then(response => {
        if(!response.data.status)
        {
